class Door:
    ...
    # Der Konstruktor trägt IMMER den Namen __init__ und weist als
    # ersten Parameter den Wert self auf.
    ...
    def __init__(self, ref2door_lock, base_color):
        ...
        # Hier wird der Setter eines Attributs
        # aufgerufen (siehe unten)
        self.color = base_color
        self._door_is_open = False
        self._door_is_locked = False

    # Nach den Konstruktoren folgen Methoden, die
    # eine Verarbeitung auslösen.
    # Danach folgen Methoden, die auf ein
    # Ereignis reagieren
    def open_the_door(self):
        """
        Methode für das öffnen der Türe.
        Das ist aber nur möglich, wenn die Türe
    ...
    def close_the_door(self):
        ...
        Das geht immer, auch wenn die Türe
    ...
    # Am Ende folgen die getter- und
    # setter-Methoden für die Attribute der Klasse
...
class DoorLock:
    """
    dummy Klasse, damit in der Klasse
    Tuere kein Fehler auftritt
    """
